...
// translated text query Parameter acquisition maxRounds，Ensure that child components can get the value immediately
const maxRounds = ref(route.query.maxRounds ? parseInt(route.query.maxRounds) : null)
const minutesPerRound = ref(30) // Default every round30minute
...
const handleGoBack = async () => {
  // translated text Step 2 translated text，translated text
  ...
  try {
    ...
    if (envStatusRes.success && envStatusRes.data?.env_alive) {
      ...
      // Environment is not running，translated text
...
const loadSimulationData = async () => {
  try {
    ...
    if (simRes.success && simRes.data) {
      ...
      // get simulation config translated text minutes_per_round
      try {
...
const loadGraph = async (graphId) => {
  // translated text，translated text loading，translated text
...
const startGraphRefresh = () => {
  ...
  // translated text，translated text30translated text
...
onMounted(() => {
  ...
  // translated text maxRounds Configuration（translated text query Parameter acquisition）
  if (maxRounds.value) {
