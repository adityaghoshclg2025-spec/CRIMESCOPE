...
const handleNextStep = (params = {}) => {
  ...
  // translated text，pass query translated text
  if (params.maxRounds) {
 ...
 * translated text Step 3 Return to Step 2 hour，translated text
 */
    ...
    if (envStatusRes.success && envStatusRes.data?.env_alive) {
      ...
      try {
        ...
        if (closeRes.success) {
          ...
          // translated text，Try to force stop
      ...
      // Environment is not running，translated text，translated text
...
onMounted(async () => {
  ...
  // Check and close running simulations（translated text Step 3 translated text）
