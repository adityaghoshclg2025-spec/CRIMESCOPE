...
// Step State
const currentStep = ref(1) // 1: Map construction, 2: Environment setup, 3: Start simulation, 4: Report generation, 5: Deep interaction
...
const handleNextStep = (params = {}) => {
  if (currentStep.value < 5) {
    ...
    // translated text Step 2 Enter Step 3，Record simulation round configuration
