...
# ============== interface1：Upload files and generate ontology ==============

@graph_bp.route('/ontology/generate', methods=['POST'])
def generate_ontology():
    """
    interface1：Upload files，Analysis generates ontology definitions
...
# ============== interface2：Build a map ==============

@graph_bp.route('/build', methods=['POST'])
def build_graph():
    """
    interface2：according toproject_idBuild a map
    ...
    try:
        ...
        # Get configuration
        graph_name = data.get('graph_name', project.name or 'CrimeScope Graph')
        ...
        def build_task():
            ...
            build_logger = get_logger('crimescope.build')
            try:
