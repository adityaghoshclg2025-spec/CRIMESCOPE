...
Zep of node/edge   UUID cursor Pagination，
 （ ）， 。
"""
...
logger = get_logger('crimescope.zep_paging')
...
def fetch_all_nodes(
    ...
    """ ，  max_items strip（default 2000）。Each page request comes with a retry。"""
    all_nodes: list[Any] = []
...
def fetch_all_edges(
    ...
    """ ， 。Each page request comes with a retry。"""
    all_edges: list[Any] = []
    cursor: str | None = None
    page_num = 0
