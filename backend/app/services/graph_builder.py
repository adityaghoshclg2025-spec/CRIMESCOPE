...
class GraphBuilderService:
    ...
    def build_graph_async(
        ...
        graph_name: str = "CrimeScope Graph",
        chunk_size: int = 500,
        ...
        Args:
            text:  
            ontology: ontology definition（ 1 ）
            graph_name:  
            chunk_size:  
            chunk_overlap:  
            batch_size:  
    ...
    def create_graph(self, name: str) -> str:
        """ ZepAtlas（public method）"""
        graph_id = f"crimescope_{uuid.uuid4().hex[:16]}"
        
        self.client.graph.create(
            graph_id=graph_id,
            name=name,
            description="CrimeScope Causal Reconstruction Graph"
        )
    ...
    def set_ontology(self, graph_id: str, ontology: Dict[str, Any]):
        ...
        #   Pydantic v2 about Field(default=None)  
        # This is Zep SDK  ， ， 
        ...
        for edge_def in ontology.get("edge_types", []):
            ...
            for attr_def in edge_def.get("attributes", []):
                ...
                # Zep API need Field of description，this is required
                attrs[attr_name] = Field(description=attr_desc, default=None)
                annotations[attr_name] = Optional[str]  #  strtype
    ...
    def _wait_for_episodes(
        ...
        """  episode Processing completed（  episode of processed  ）"""
