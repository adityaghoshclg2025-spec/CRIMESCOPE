...
fromZep ，Filter out nodes matching predefined entity types
"""
...
logger = get_logger('crimescope.zep_entity_reader')
...
class ZepEntityReader:
    ...
    ZepEntity reading and filtering service
     ...
     ：
    1. fromZep 
    2. Filter out nodes matching predefined entity types（Labels Entity ）
    3.  
    """
    ...
    def _call_with_retry(
        ...
        Args:
            func:  （ lambdaorcallable）
            operation_name:  ， 
            max_retries: Maximum number of retries（default3Second-rate， 3Second-rate）
            initial_delay:  
    ...
    def get_all_nodes(self, graph_id: str) -> List[Dict[str, Any]]:
        ...
        """
        logger.info(f"Get map {graph_id}  ...")
    ...
    def get_node_edges(self, node_uuid: str) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            logger.warning(f"Get node {node_uuid}  : {str(e)}")
            return []
    ...
    def filter_defined_entities(
        ...
        Filter out nodes matching predefined entity types
         ...
         ：
        - If the nodesLabels "Entity"， ，jump over
        - If the nodesLabels "Entity"and"Node"tags outside， ， 
        
        Args:
            graph_id: AtlasID
            defined_entity_types:  （Optional， ）
            enrich_with_edges:  
        ...
        for node in all_nodes:
            ...
            #  ：Labels "Entity"and"Node"tags outside
    ...
    def get_entity_with_context(
        ...
        try:
            ...
            logger.error(f"  {entity_uuid} fail: {str(e)}")
            return None
