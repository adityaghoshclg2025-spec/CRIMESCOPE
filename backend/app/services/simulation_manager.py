...
class SimulationManager:
    ...
    def prepare_simulation(
        ...
        2. generated for each entityOASIS Agent Profile（OptionalLLM ， ）
        3. useLLMIntelligent generation of simulation configuration parameters（ 、 、 ）
        4.  Profiledocument
        5.  
        ...
        Args:
            ...
            simulation_requirement: Simulation requirement description（used forLLM ）
            document_text: Original document content（used forLLM ）
            defined_entity_types:  （Optional）
            use_llm_for_profiles: Whether to useLLMGenerate detailed persona
            progress_callback: Progress callback function (stage, progress, message)
            parallel_profile_count:  ，default3
        ...
        try:
            ...
            if state.enable_twitter:
                # TwitteruseCSVFormat！This isOASIS 
                generator.save_profiles(
                    profiles=profiles,
            ...
            # Notice：  backend/scripts/ Table of contents，No longer copied to mock directory
    ...
    def get_run_instructions(self, simulation_id: str) -> Dict[str, str]:
        ...
        return {
            ...
            "instructions": (
                f"1.  conda : conda activate crimescope\n"
                f"2.   (The script is located at {scripts_dir}):\n"
