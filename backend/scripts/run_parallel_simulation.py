...
class ParallelIPCHandler:
    """
    Dual platformIPCcommand processor
    ...
    async def handle_batch_interview(self, command_id: str, interviews: List[Dict], platform: str = None) -> bool:
        ...
        Args:
            ...
            platform: Default platform（can be used by eachinterviewitem coverage）
                - "twitter": Interview onlyTwitterplatform
                - "reddit": Interview onlyRedditplatform
                - None/Not specified: eachAgentInterview on two platforms at the same time
        """
        # Group by platform
        twitter_interviews = []
        reddit_interviews = []
        ...
        if results:
            ...
            print(f"  batchInterviewFinish: {len(results)} indivualAgent")
            return True
        else:
    ...
    def _get_interview_result(self, agent_id: int, platform: str) -> Dict[str, Any]:
        ...
        try:
            ...
            print(f"  readInterviewresult failed: {e}")
...
def setup_signal_handlers(loop=None):
    ...
    Persistence simulation scenario：Do not exit after simulation is completed，wait interview Order
